...
if __name__ == '__main__':
    ...
    results = epidemicModel(df.iloc[start:stop+window_size+1,:],window_size).optimize(n_iter)
    fname = 'epidemic model - windowsize {} - periods {} to {} - iter {} - {}.npy'.format(window_size,start,stop,n_iter,time.time())
